...
class ClinicDetailHistoriesTableSeeder extends Seeder
{
    /**
    ...
    {
        //Data Type
        $dataType = $this->dataType('slug', 'clinic_detail_histories');
        if (!$dataType->exists) {
            $dataType->fill([
                'name'                  => 'clinic_detail_histories',
                'display_name_singular' => __('voyager::seeders.data_types.clinic_detail_histories.singular'),
                'display_name_plural'   => __('voyager::seeders.data_types.clinic_detail_histories.plural'),
                'icon'                  => 'voyager-news',
                'model_name'            => 'App\\DetailHistories',
