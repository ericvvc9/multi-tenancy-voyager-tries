...
class SideMenuContent extends React.Component {
  ...
  render() {
    ...
    /* if(this.props.currentUser && this.props.currentUser.userData ? this.props.currentUser.userData && this.props.currentUser.userData ? this.props.currentUser.userData.roles && this.props.currentUser.userData ? this.props.currentUser.userData.roles)  : "" {
      
    } */
    /* let menuItems = navigationConfig.filter((item) => {
      return true
      //this.props.currentUser.roles.name
    }) */
    // eslint-disable-next-line
    let menuItems = navigationConfig;
    menuItems = menuItems.map((item,key) => {
      const CustomAnchorTag = item.type === "external-link" ? `a` : Link
      // checks if item has groupheader
      if (item.type === "groupHeader" && !!
        item.permissions.includes(this.props.currentUser.userData && this.props.currentUser.userData.roles ? this.props.currentUser.userData.roles.name : "" )
      ) {
        return (
          <li
